 ...
 *	@brief decimal_to_anybase is a tiny C program wich convert positive decimal integer to any positive base with base's alphabet given in input (recursive way)
 **/
